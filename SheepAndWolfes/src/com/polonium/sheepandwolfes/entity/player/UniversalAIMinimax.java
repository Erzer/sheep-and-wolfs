...
public class UniversalAIMinimax implements Player {
    ...
    public UniversalAIMinimax(int deep) {
        this.deep = deep;
    }

    @Override
    public UniversalAIMinimax makeMove(GameState gameState, OnMakeMoveListener listener) {
    ...
    class Thinker extends AsyncTask<Void, Void, GameState> {
        ...
        protected void onPostExecute(GameState result) {
           if (!mGameOver) makeMoveListener.onMoveComlete(UniversalAIMinimax.this, result);
        }
